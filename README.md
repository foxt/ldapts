...
- [LDAPts](#ldapts)
  ...
  - [`using` declaration with Typescript](#using-declaration-with-typescript)
  - [Configuring Secure Connections](#configuring-secure-connections)
    - [Use `Client` Constructor for LDAPS](#use-client-constructor-for-ldaps)
    - [Use `client.startTLS` for STARTTLS](#use-clientstarttls-for-starttls)
  - [Common Errors](#common-errors)
    ...
    - [Handshake inactivity timeout](#handshake-inactivity-timeout)
